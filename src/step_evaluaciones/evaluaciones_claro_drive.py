...
class EvaluacionesClaroDriveSteps:
    ...
    def cerrar_sesion_claro_drive(self, webdriver_test_ux: WebDriver, jsonEval):
        ...
        try:
            boton_ajustes = HtmlActions.webdriver_wait_element_to_be_clickable(webdriver_test_ux, 10, id='expand')

            HtmlActions.click_html_element(boton_ajustes, id='expand')

            boton_cerrar_sesion = HtmlActions.webdriver_wait_element_to_be_clickable(
                webdriver_test_ux, 20, xpath='//li[@data-id="logout"]/a')

            HtmlActions.click_html_element(boton_cerrar_sesion, xpath='//li[@data-id="logout"]/a')

            tiempo_step_inicio = Temporizador.obtener_tiempo_timer()

            HtmlActions.webdriver_wait_presence_of_element_located(webdriver_test_ux, 10, id='login')
